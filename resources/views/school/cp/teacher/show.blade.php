    ...
    <div class="col-lg-4 side-left d-flex align-items-stretch">
        ...
        <div class="col-12 grid-margin stretch-card">
            ...
            <div class="card-body avatar">
                ...
                <form action="/{{ $lang }}{{ $path }}d-e-teacher/{{ $teacher->id }}" method="POST">
                {{ csrf_field() }}
    ...
    <div class="col-lg-8 side-right stretch-card">
        ...
        <div class="card-body">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <form action="/{{ $lang }}{{ $path }}update-information-teacher/{{ $teacher->id }}" method="POST">
                {{ csrf_field() }}
                ...
                <form action="/{{ $lang }}{{ $path }}update-image-teacher/{{ $teacher->id }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                    <div class="form-group">
                ...
                <form action="/{{ $lang }}{{ $path }}update-password-teacher/{{ $teacher->id }}" method="POST">
                {{ csrf_field() }}
