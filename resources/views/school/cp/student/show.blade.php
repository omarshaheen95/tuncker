    ...
    <div class="col-lg-8 side-right stretch-card">
        ...
        <div class="card-body">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <form action="/{{ $lang }}{{ $path }}update-information-student/{{ $student->id }}" method="POST">
                {{ csrf_field() }}
                    ...
                    <option>{{ trans('indexing.teacher') }}</option>
                ...
                <form action="/{{ $lang }}{{ $path }}update-image-student/{{ $student->id }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                    <div class="form-group">
