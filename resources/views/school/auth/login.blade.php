...
<div class="row">
    <div class="col-lg-6 bg-white pattern">
        ...
        @endif
        <form class="pt-4" role="form" method="POST" action="{{  url('/school/login')}}">
                        {{ csrf_field() }}
            ...
            <div class="mt-3 text-center">
                <a href="/{{ $lang }}/school/password/reset" class="auth-link text-black">{{ trans('main.forgot') }}</a>
            </div>
            <div class="mt-3 text-center">
                <a href="/{{ $lang }}/school/register" class="auth-link text-black">{{ trans('main.register') }}</a>
            </div>
            <div class="mt-3 text-center">
