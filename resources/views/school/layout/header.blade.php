        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <div class="dropdown-divider"></div>
              <a class="dropdown-item preview-item" href="/{{ $lang }}/school/profile">
              ...
              <div class="dropdown-divider"></div>
              <a class="dropdown-item preview-item" href="{{ url('/school/logout') }}"
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/{{ $lang }}/school/home">
                <i class="icon-home menu-icon"></i>
                <span class="menu-title">{{ trans('main.home') }}</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/{{ $lang }}/school/teacher">
                <i class="icon-people menu-icon"></i>
                <span class="menu-title">{{ trans('main.teachers') }}</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/{{ $lang }}/school/teacher/create">
                <i class="icon-plus menu-icon"></i>
                <span class="menu-title">{{ trans('main.new_teacher') }}</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/{{ $lang }}/school/student">
