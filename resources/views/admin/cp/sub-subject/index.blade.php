...
<div class="card">
  <div class="card-body">
    ...
    <h5><a href="/admin/sub-subject/create"><i class="icon-plus icon-menu"></i>مادة جديدة</a></h5>
    <div class="row">
      <div class="col-12">
            ...
            @foreach ($subjects as $subject)
              <tr>
                  @if ($lang == 'ar')
                    ...
                    <a class="btn btn-primary" href="{{ $path }}-standards/{{ $subject->id }}" target="_blank">
                      <i class="icon-menu"></i>
