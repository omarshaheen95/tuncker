                      ...
                      @foreach ($students as $student)
                        <tr>
                          ...
                          @endif
                            ...
                            | <a class="btn btn-primary" href="/{{ $lang }}{{ $path }}/{{ $student->id }}" target="_blank">{{ trans('error.show') }}</a> | <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteStudent-{{ $student->id }}" >{{ trans('error.delete') }} </button></td>
                        </tr>
