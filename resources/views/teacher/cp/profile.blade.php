    ...
    <div class="col-lg-4 side-left d-flex align-items-stretch">
        ...
        <div class="col-12 stretch-card">
            ...
            <div class="card-body overview">
                ...
                <p>
                    @if ($lang == 'ar')
                      {{ Auth::user()->ar_description }}
                    @elseif($lang == 'en')
                        {{ Auth::user()->en_description }}
                    @endif
                </p>
                </div>
            </div>
    ...
    <div class="col-lg-8 side-right stretch-card">
        ...
        <div class="card-body">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <form action="/{{ $lang }}/teacher/update-information" method="POST">
                {{ csrf_field() }}
                    ...
                    <textarea name="ar_description" rows="6" class="form-control" placeholder="Change address">{{ Auth::user()->ar_description }}</textarea>
                    </div>
                    <div class="form-group">
                    <label for="address">{{ trans('profile.en_description') }}</label>
                    <textarea name="en_description" rows="6" class="form-control" placeholder="Change address">{{ Auth::user()->en_description }}</textarea>
                    </div>
                ...
                <form action="/{{ $lang }}/teacher/update-image" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                    <div class="form-group">
                      <label>{{ trans('profile.avatar') }}</label>
                      <input type="file" multiple name="image" class="file-upload-default">
                ...
                <form action="/{{ $lang }}/teacher/update-password" method="POST">
                {{ csrf_field() }}
                    <div class="form-group">
...
@section('script')
    ...
    <script src="{{ asset('cp/js/jquery-file-upload.js') }}"></script>
@stop
