...
@endif
@section('content')
<form action="{{ $path }}update-standard/{{ $standard->id }}" method="POST" >
    {{ csrf_field() }}
<div class="row">
                        ...
                        <div class="card-body">
                            ...
                            {{ trans('indexing.new_standard') }}
                                ...
                                <select name="sub_subject_id" class="form-control">
                                    ...
                                    @if ($standard->sub_subject_id == $s_subject->id)
                                        <option selected value="{{ $s_subject->id }}">{{ $s_subject->ar_name }}</option>
                                    @else
                                ...
                                <textarea class="form-control" name="standard">{{ $standard->standard }}</textarea>
                                </div>
